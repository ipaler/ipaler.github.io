...
function(a) {
    ...
    u.prototype = {
        ...
        open: function(c) {
            ...
            b.bgOverlay || (b.bgOverlay = y("bg").on("click" + q,
            function() {
                b.close()
            }), b.wrap = y("wrap").attr("tabindex", -1).on("click" + q,
            function(a) {
            ...
            z("BeforeOpen"),
            b.st.showCloseBtn && (b.st.closeBtnInside ? (x(m,
            function(a, b, c, d) {
            ...
            b.st.enableEscapeKey && e.on("keyup" + q,
            function(a) {
        ...
        proto: {
            initZoom: function() {
                ...
                if (c.enabled && b.supportsTransition) {
                    ...
                    function() {
                        if (b._allowZoom()) {
                            if (clearTimeout(e), b.content.css("visibility", "hidden"), a = b._getItemToZoom(), !a) return k(),
                            void 0;
                            f = h(a),
                            f.css(b._getOffset()),
                            b.wrap.append(f),
    ...
    a.magnificPopup.registerModule("gallery", {
        ...
        proto: {
            initGallery: function() {
                ...
                c && c.enabled ? (g += " mfp-gallery", x(n + d,
                function() {
                    c.navigateByImgClick && b.wrap.on("click" + d, ".mfp-img",
                    function() {
...
function(a) {
    ...
    c.mediaQueriesSupported = a.matchMedia && a.matchMedia("only all").matches, !c.mediaQueriesSupported) {
        ...
        t = function(a, b, c) {
            ...
            for (var h = 0; e > h; h++) {
                var k, l, m, n;
                g ? (k = c, j.push(f(a))) : (k = d[h].match(/@media *([^\{]+)\{([\S\s]+?)$/) && RegExp.$1, j.push(RegExp.$2 && f(RegExp.$2))),
                m = k.split(","),
                n = m.length;
                for (var o = 0; n > o; o++) l = m[o],
                i.push({
        ...
        u = function() {
            ...
            c || (c = d = g.createElement("body"), c.style.background = "none"),
            c.appendChild(b),
        ...
        v = function(b) {
            ...
            r = p[p.length - 1],
            s = (new Date).getTime();
            if (b && d && m > s - d) return a.clearTimeout(e),
            e = a.setTimeout(v, m),
            void 0;
            d = s;
            for (var t in i) if (i.hasOwnProperty(t)) {
                ...
                w.hasquery && (z && A || !(z || o >= x) || !(A || y >= o)) || (q[w.media] || (q[w.media] = []), q[w.media].push(j[w.rules]))
            }
...
var responsiveNav = function(a, b) {
    ...
    l = function(a, b, c, d) {
        if ("addEventListener" in a) try {
            ...
            d)
        } else "attachEvent" in a && ("object" == typeof c && c.handleEvent ? a.attachEvent("on" + b,
        function() {
    ...
    m = function(a, b, c, d) {
        if ("removeEventListener" in a) try {
            ...
            d)
        } else "detachEvent" in a && ("object" == typeof c && c.handleEvent ? a.detachEvent("on" + b,
        function() {
            c.handleEvent.call(c)
    ...
    r.prototype = {
        ...
        _createToggle: function() {
            if (f.customToggle) {
                ...
                "after" === f.insert ? e.parentNode.insertBefore(c, e.nextSibling) : e.parentNode.insertBefore(c, e),
                g = b.getElementById("nav-toggle")
            }
        },
        ...
        _ontouchend: function() {
            var a = this;
            e.addEventListener("click", a._preventDefault, !0),
            setTimeout(function() {
        ...
        _resize: function() {
            "none" !== a.getComputedStyle(g, null).getPropertyValue("display") ? (o(g, {
                ...
                "aria-hidden": "false"
            }), e.style.position = f.openPos, this._removeStyles()),
            f.init()
        }
    };
    var s;
...
function(a) {
    a.fn.jekyllSearch = function(b) {
        function c() {
            i.keyup(function(b) {
                13 === b.which && k && (window.location = k[0].url),
        ...
        function d(a) {
            ...
            for (var b = 0; b < h.length; b++) {
                var c = h[b];
                for (key in c) if (c.hasOwnProperty(key)) if (c[key] instanceof Array) {
                    for (var d = 0; d < c[key].length; d++) if (c[key][d].toLowerCase().indexOf(a.toLowerCase()) >= 0) {
                        k.push(c);
                        break
                    }
                } else if (c[key].toLowerCase().indexOf(a.toLowerCase()) >= 0) {
                    k.push(c);
                    break
                }
            }
        ...
        function e(b) {
            if (f(), j.append(a(g.searchResultsTitle)), b && b.length) for (var c = 0; c < b.length && c < g.limit; c++) {
                var d = b[c];
                output = g.template,
        ...
        j = a(g.searchResults),
        k = [];
        g.jsonFile.length && j.length && a.ajax({
            type: "GET",
            url: g.jsonFile,
            dataType: "json",
            success: function(a) {
